...
# Pipeline code (production modules only; excludes worker, train_server, main, jobs, domain_client, speed_test)
...
ENV SPLATTER_ENABLE_LIGHTFELD_COLMAP=true
ENV SPLATTER_USE_LEGACY_COLMAP_RUN_PY=false

# Non-root runtime and writable workspace for task payloads
